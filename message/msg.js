...
//Setting ke 2
const nobot = "6282298483755"

// Setting Donasi
const gopay = "0821-8997-5711"
const ovo = "0821-8997-5711"
const dana = "0821-8997-5711"
const pulsa = "0821-8997-5711"
const pulsa2 = "0821-8997-5711"
const insta = "xychaann"
const github = "XyChaann"
...
module.exports = async(conn, msg, m, setting, store) => {
	...
	return x;
		...
		const buttonsDefault = [
			{ urlButton: { displayText: `Join Grup`, url : `https://chat.whatsapp.com/GikyZutq2lc7ajrz5RZtex` } },
			{ urlButton: { displayText: `Nomer Owner`, url : `https://wa.me/6282189975711?text=Hai+kak+aku+mau+beli+PREMIUM` } },
			{ quickReplyButton: { displayText: `👤 Owner`, id: `${prefix}owner` } },
			{ quickReplyButton: { displayText: `📝️ Rules`, id: `${prefix}rules` } },
			{ quickReplyButton: { displayText: `List Command`, id: `${prefix}listmenu` } },			
		]
		...
		const button5 = [
			{ callButton: { displayText: `Number Owner`, phoneNumber: `0821-8997-5711` } },
			{ urlButton: { displayText: `Join Grup`, url : `https://chat.whatsapp.com/GikyZutq2lc7ajrz5RZtex` } },
...
if (chats.startsWith("@6282189975711")){
...
case prefix+'rules':
  var rulesbot = [
			{ urlButton: { displayText: `Join Grup`, url : `https://chat.whatsapp.com/GikyZutq2lc7ajrz5RZtex` } },
			{ quickReplyButton: { displayText: `List Command`, id: `${prefix}menu` } },
		]
var teks = `  
┌── ⫹⫺ *Rules Bot*
│
...
│  Jika sudah dipahami rules-nya, silakan 
...
└───────────── ⫹⫺
`
 conn.sendMessage(from, { caption: teks, image: {url: `https://i.ibb.co/YRff8Wh/Jojo2.jpg`}, templateButtons: rulesbot, footer: '© XyChan Team', mentions: [sender]} )  
			    break
case prefix+'sewa':
...
└───────────── ⫹⫺
`
 conn.sendMessage(from, { caption: teks, image: {url: `https://i.ibb.co/YRff8Wh/Jojo2.jpg`}, templateButtons: sewabot, footer: '© XyChan Team', mentions: [sender]} )  
			    break
			case prefix+'runtime':
			...
			case prefix+'owner':
			    for (let x of ownerNumber) {
			      sendContact(from, x.split('@s.whatsapp.net')[0], 'XyChan', msg)
			    }
		...
		conn.sendMessage(from, {text: `Ingin bertanya tanya tentang apa?`, templateButtons: owncuy, footer: `© XyChan Team`, mentions: [sender]} )
			    break
case prefix+'igowner':
...
case prefix+'githubown':
 ...
 break
			...
			{ quickReplyButton: { displayText: `Ubah Ke Audio`, id: `${prefix}tiktokaudio ${q}` } },
				...
				reply(mess.wait)
				conn.sendMessage(from, { caption: `Succes Download Video Tiktok, Thanks For Using Someone-Md!`, video: {url: data.nowm}, templateButtons: tidtod, footer: '© XyChan Team', mentions: [sender]} )
...
case prefix+'bc': case prefix+'broadcast':
			    if (!isOwner) return reply(mess.OnlyOwner)
		            if (args.length < 2) return reply(`Masukkan isi pesannya`)
                            ...
                            for (let i of data) {
                               conn.sendMessage(i.id, { text: `*[ Someone-Md BROADCAST ]*\n\n${q}` })
                               await sleep(1000)
                            }
                            break
...
│
╰──⫹⫺`
conn.sendMessage(from, { caption: teks, image: {url: `https://d.top4top.io/p_23662vazr9.jpg`}, templateButtons: buttonsDefault, footer: '© XyChan Team', mentions: [sender]} )
            break
case prefix+'listmenu':
var teks = listmenu(sender, prefix, pushname, isOwner, isPremium, balance, limit, limitCount, glimit, gcount)
 conn.sendMessage(from, { caption: teks, image: {url: `https://d.top4top.io/p_23662vazr9.jpg`}, templateButtons: buttonsDefault2, footer: '© XyChan Team', mentions: [sender]} )
            break
case prefix+'bisakah':
  case prefix+'bisa':
    case prefix+'bisagak':
...
case prefix+'script':
  case prefix+'sc':
reply("╭──⫹⫺「 Source Script 」\n│\n├ Base Ori : https://github.com/rtwone/chitandabot\n│\n├ Base Recode : Coming Soon\n│\n╰──⫹⫺")
break
//Api Anto
case prefix+'ssweb':
  if (!isUrl(args[1])) return reply(mess.error.Iv)
...
conn.sendMessage(from, {caption: `Ｓｕｃｃｅｓ．．．`, image: {url: hasil}}, {quoted: msg})
break
...
└───────────── ⫹⫺
`
 conn.sendMessage(from, { caption: teks, image: {url: `https://c.top4top.io/p_2356l30ia9.jpg`}, templateButtons: sewabot, footer: '© XyChan Team', mentions: [sender]} )  
			    break
case prefix+'blowjob':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
...
var cimcimi = await fetchJson(`https://api.simsimi.net/v2/?text=${text}&lc=id`)
  ...
  break
case prefix+'bokep':
var teks = `*Hii! ${pushname} Selamat ${jamss} Todd*


  ╭── ❏ *List Menu [ Bokep ]*
  │
  │ 🔖 ${prefix}indo
  │ 🔖 ${prefix}jepang [ coming soon ]
  │ 🔖 ${prefix}russia [ coming soon ]
  │ 🔖 ${prefix}barat [ coming soon ]  
  │
  ╰────────────── ❏`
conn.sendMessage(from, { caption: teks, image: {url: `https://d.top4top.io/p_23662vazr9.jpg`}, templateButtons: buttonsDefault3, footer: '© XyChan Team', mentions: [sender]} )
            break
case prefix+'indo':
case prefix+'bokep__1':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__2` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__2':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__3` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo2.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__3':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__4` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo3.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__4':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__5` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo4.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__5':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__6` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo5.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__6':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__7` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo6.mp4'), mentions: [sender]} )
			    break			    
case prefix+'bokep__7':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__8` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo7.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__8':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__9` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo8.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__9':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__10` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo9.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__10':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__11` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo10.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__11':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__12` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo11.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__12':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__13` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo12.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__13':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__14` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo13.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__14':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__15` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo14.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__15':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__16` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo15.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__16':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__17` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo16.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__17':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__18` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo17.mp4'), mentions: [sender]} )
			    break	    			
case prefix+'bokep__18':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__19` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo18.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__19':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__20` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo19.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__20':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__21` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo20.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__21':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__22` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo21.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__22':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__23` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo22.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__23':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__24` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo23.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__24':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__25` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo24.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__25':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__26` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo25.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__26':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__27` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo26.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__27':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__28` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo27.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__28':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__29` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo28.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__29':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__30` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo29.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__30':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__31` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo30.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__31':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__1` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo31.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__22':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
...
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__32` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo31.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__32':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__33` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo32.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__33':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__34` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo33.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__34':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__35` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo34.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__35':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__36` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo35.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__36':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__37` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo36.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__37':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__38` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo37.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__38':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__39` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo38.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__39':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__40` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo39.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__40':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__41` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo40.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__41':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__42` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo41.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__42':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__43` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo42.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__43':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__44` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo43.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__44':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__45` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo44.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__45':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__46` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo45.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__46':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__47` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo46.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__47':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__48` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo47.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__48':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__49` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo48.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__49':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__50` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo49.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__50':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__51` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo50.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__51':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__52` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo51.mp4'), mentions: [sender]} )
			    break			    			    
			    case prefix+'bokep__52':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__53` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo52.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__53':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__54` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo53.mp4'), mentions: [sender]} )
			    break			    			    
			    case prefix+'bokep__54':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__55` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo54.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__52':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
...
var quot = [
 ...
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo54.mp4'), mentions: [sender]} )
			    break			    			    
			    case prefix+'bokep__55':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__56` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo55.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__56':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__57` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo56.mp4'), mentions: [sender]} )
			    break			    			    
			    case prefix+'bokep__57':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
			{ quickReplyButton: { displayText: `Next Video ➡️`, id: `${prefix}bokep__58` } },
		]
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo57.mp4'), mentions: [sender]} )
			    break
case prefix+'bokep__58':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
var teks = `Ｓｕｃｃｅｓ．．．`  
var quot = [
 ...
 conn.sendMessage(from, { caption: teks, templateButtons: quot, video: fs.readFileSync('fitur/comly/Indo58.mp4'), mentions: [sender]} )
			    break			    			    
case prefix+'igstalk':
  case prefix+'stalkig':
    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, { text: caption, buttons: but, footer: "© XyChaan Team", templateButtons: but }, {quoted: msg})
limitAdd(sender, limit)
break
//maker arasya
case prefix+'leaves':
